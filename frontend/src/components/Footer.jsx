...
const Footer = () => {
  ...
  return (
    <footer className={`border-t ${theme.colors.border} transition-colors duration-300 mt-4 py-4 ${isDark ? 'bg-slate-800/50 backdrop-blur-sm' : 'bg-gray-50 backdrop-blur-sm'}`}>
